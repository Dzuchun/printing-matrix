...
/// Contains [`DrukarniaApi`] trait, as well as it's provided implementations
///
...
/// Contains data objects as well as some infrastructure for their definition and usage.
///
...
pub use client::{DrukarniaApi, ReqwestApi};
